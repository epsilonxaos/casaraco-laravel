            ...
            <form action="{{ route('panel.website.update', ['seccion' => request('seccion')]) }}"
                ...
                <div class="w-full">
                    <div class=" mb-6">
                        ...
                        <div class="mb-3">
                            <label for="url_casa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Url
                                Casa
                                cuahuila</label>
                            <input id="url_casa" name="url_casa" value="{{ $data->url_casa }}" autocomplete="off"
                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class="mb-3">
                            <label for="url_sala" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Url
                                Sala de juntas</label>
                            <input id="url_sala" name="url_sala" value="{{ $data->url_sala }}" autocomplete="off"
                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class="mb-3">
                            <label for="url_habitaciones"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Url
                                Habitaciones</label>
                            <input id="url_habitaciones" name="url_habitaciones" value="{{ $data->url_habitaciones }}"
                                autocomplete="off"
                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        ...
                        <div id="tab-content-secc1">
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="es-secc1" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="desc_casa_es">Descripción Casa cuahuila</label>
                                    <textarea name="desc_casa_es" class="trumbowyg-panel" cols="30" rows="3">{{ $data->desc_casa_es }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="en-secc1" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="desc_casa_en">Descripción Casa cuahuila</label>
                                    <textarea name="desc_casa_en" class="trumbowyg-panel" cols="30" rows="3">{{ $data->desc_casa_en }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="desc_sala_en">Descripción Sala de juntas</label>
                                    <textarea name="desc_sala_en" class="trumbowyg-panel" cols="30" rows="3">{{ $data->desc_sala_en }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="desc_habitaciones_en">Descripción habitaciones</label>
                                    <textarea name="desc_habitaciones_en" class="trumbowyg-panel" cols="30" rows="3">{{ $data->desc_habitaciones_en }}</textarea>
                                </div>
