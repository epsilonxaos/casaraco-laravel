...
export const Habitaciones = () => {
	return (
		<section className="bg-no-repeat bg-right-top bg-cover py-10 lg:py-16" style={{ backgroundImage: "url(/img/home/fondo-habitaciones.jpg)" }}>
...
const CardHabitacion = () => {
	...
	return (
		<div className="absolute bg-[#d6c0ac] text-center w-full md:max-w-[365px] py-7 px-5 md:px-7 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:min-h-[515px]">
			<img src="/img/home/Sello.png" alt="Sello" className="size-[60px] md:size-[118px] mx-auto mb-4" />
